package com.orange.jpa.query.domain.entity.order.customer;
...
public class QCustomer extends EntityPathBase<Customer> {
    ...
    private static final long serialVersionUID = -1308279856L;
    ...
    public final ListPath<com.orange.jpa.query.domain.entity.order.Order, com.orange.jpa.query.domain.entity.order.QOrder> orderList = this.<com.orange.jpa.query.domain.entity.order.Order, com.orange.jpa.query.domain.entity.order.QOrder>createList("orderList", com.orange.jpa.query.domain.entity.order.Order.class, com.orange.jpa.query.domain.entity.order.QOrder.class, PathInits.DIRECT2);
